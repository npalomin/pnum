...
Plot
```{r echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, dpi=300, out.width="2000px"}
tmap_mode("plot")
mH
```
...
```{r echo=FALSE, fig.height=6, fig.width=12, dpi=300, out.width="2000px"}
fullA1_m <- tm_shape(fullA1) +
  ...
  tm_borders(col = "cyan",
             alpha = 0.5) +
  tm_layout(inner.margins = c(0, 0.1, 0.05, 0.2), 
            frame = F) +
  tm_legend(legend.position = c("right", "bottom"))
fullA1_m
```
